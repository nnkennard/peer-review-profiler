...
parser = argparse.ArgumentParser(
    description=
    'Find features that are significantly correlated with an annotation field')
...
def main():
  ...
  for feature_name in get_all_feature_names(features_file):
    feature_correlations[feature_name] = get_correlation(
        feature_values[feature_name], feature_values['score'])
